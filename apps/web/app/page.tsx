      ...
      <main className="flex-1 flex flex-col items-center px-6 pt-20 pb-16">
        <div className="text-center max-w-2xl">
          ...
          <div className="mb-20">
            ...
            <p className="text-[13px] text-[var(--muted)] font-sans mb-6">
              Add the orfc skill to your AI coding tool
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-md mx-auto">
              {/* Add to Claude Code */}
              <div className="w-full sm:w-auto">
                <div className="bg-[#0d1117] rounded-xl p-4 shadow-[0_4px_24px_rgba(0,0,0,0.12)]">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-[13px] text-gray-300 font-sans font-medium">
                      Claude Code
                    </span>
                  </div>
                  <CopyCommand command="npm install -g @orfc/cli" />
                  <p className="text-[11px] text-gray-500 font-sans mt-2">
                    Installs CLI + /orfc skill automatically
                  </p>
                </div>
              </div>
              ...
              <div className="w-full sm:w-auto">
                <div className="bg-[#0d1117] rounded-xl p-4 shadow-[0_4px_24px_rgba(0,0,0,0.12)]">
                  ...
                  <CopyCommand command="npx @orfc/cli install-skill" />
                  <p className="text-[11px] text-gray-500 font-sans mt-2">
                    Adds orfc rules to your project
                  </p>
                </div>
              </div>
            </div>
